...
autoload :ACK_N02, File.dirname(__FILE__) + '/messages/ack_n02.rb'
...
autoload :RSP_K13, File.dirname(__FILE__) + '/messages/rsp_k13.rb'
autoload :RSP_K15, File.dirname(__FILE__) + '/messages/rsp_k15.rb'
...
autoload :RSP_K24, File.dirname(__FILE__) + '/messages/rsp_k24.rb'
...
autoload :RTB_Q13, File.dirname(__FILE__) + '/messages/rtb_q13.rb'
