...
class Ma < ::HealthSeven::DataType
  ...
  attribute :sample_1_from_channel_4, Nm, minOccurs: "0", maxOccurs: "1"
  # sample 1 from channel 5
  attribute :sample_1_from_channel_5, Nm, minOccurs: "0", maxOccurs: "1"
  # sample 1 from channel 6
  attribute :sample_1_from_channel_6, Nm, minOccurs: "0", maxOccurs: "1"
end
end