...
class Om7 < ::HealthSeven::Segment
  ...
  attribute :universal_service_identifier, Ce, position: "OM7.2", require: true
  # Category Identifier
  attribute :category_identifiers, Array[Ce], position: "OM7.3", multiple: true
  ...
  attribute :effective_test_service_start_date_time, Ts, position: "OM7.6"
  # Effective Test/Service End Date/Time
  attribute :effective_test_service_end_date_time, Ts, position: "OM7.7"
  ...
  attribute :test_service_default_duration_units, Ce, position: "OM7.9"
  ...
  # Consent Identifier
  attribute :consent_identifier, Ce, position: "OM7.12"
  # Consent Effective Start Date/Time
  attribute :consent_effective_start_date_time, Ts, position: "OM7.13"
  # Consent Effective End Date/Time
  attribute :consent_effective_end_date_time, Ts, position: "OM7.14"
  # Consent Interval Quantity
  attribute :consent_interval_quantity, Nm, position: "OM7.15"
  # Consent Interval Units
  attribute :consent_interval_units, Ce, position: "OM7.16"
  # Consent Waiting Period Quantity
  attribute :consent_waiting_period_quantity, Nm, position: "OM7.17"
  # Consent Waiting Period Units
  attribute :consent_waiting_period_units, Ce, position: "OM7.18"
  # Effective Date/Time of Change
  attribute :effective_date_time_of_change, Ts, position: "OM7.19"
  # Entered By
  ...
  attribute :primary_key_value_cdms, Array[Ce], position: "OM7.24", multiple: true
end
end