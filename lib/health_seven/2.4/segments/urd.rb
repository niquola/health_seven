...
class Urd < ::HealthSeven::Segment
  # R/U Date/Time
  attribute :r_u_date_time, Ts, position: "URD.1"
  # Report Priority
  ...
  attribute :r_u_what_subject_definitions, Array[Ce], position: "URD.4", multiple: true
  # R/U What Department Code
  attribute :r_u_what_department_codes, Array[Ce], position: "URD.5", multiple: true
