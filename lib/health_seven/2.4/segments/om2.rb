...
class Om2 < ::HealthSeven::Segment
  ...
  attribute :reference_normal_range_ordinal_and_continuous_observations, Rfr, position: "OM2.6"
  # Critical Range for Ordinal and Continuous Observations
  attribute :critical_range_for_ordinal_and_continuous_observations, Nr, position: "OM2.7"
