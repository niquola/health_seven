...
class Sac < ::HealthSeven::Segment
  ...
  # Available Volume
  attribute :available_volume, Nm, position: "SAC.22"
  ...
  # Additive
  attribute :additives, Array[Ce], position: "SAC.27", multiple: true
  # Specimen Component
  ...
  attribute :special_handling_considerations, Array[Ce], position: "SAC.43", multiple: true
