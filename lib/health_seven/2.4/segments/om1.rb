...
class Om1 < ::HealthSeven::Segment
  ...
  attribute :producer_s_service_test_observation_id, Ce, position: "OM1.2", require: true
  ...
  attribute :other_service_test_observation_ids_for_the_observation, Ce, position: "OM1.7"
  # Other Names
  ...
  attribute :nature_of_service_test_observation, Is, position: "OM1.18", require: true
  # Report Subheader
  ...
  attribute :factors_that_may_affect_affect_the_observation, Tx, position: "OM1.39"
