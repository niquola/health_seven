...
class Abs < ::HealthSeven::Segment
  ...
  attribute :transfer_medical_service_code, Ce, position: "ABS.2"
  # Severity of Illness Code
  attribute :severity_of_illness_code, Ce, position: "ABS.3"
  # Date/Time of Attestation
  attribute :date_time_of_attestation, Ts, position: "ABS.4"
  # Attested By
  attribute :attested_by, Xcn, position: "ABS.5"
  # Triage Code
  attribute :triage_code, Ce, position: "ABS.6"
  # Abstract Completion Date/Time
  attribute :abstract_completion_date_time, Ts, position: "ABS.7"
  # Abstracted By
  attribute :abstracted_by, Xcn, position: "ABS.8"
  # Case Category Code
  attribute :case_category_code, Ce, position: "ABS.9"
  # Caesarian Section Indicator
  attribute :caesarian_section_indicator, Id, position: "ABS.10"
  # Gestation Category Code
  attribute :gestation_category_code, Ce, position: "ABS.11"
  # Gestation Period - Weeks
  attribute :gestation_period_weeks, Nm, position: "ABS.12"
  # Newborn Code
  attribute :newborn_code, Ce, position: "ABS.13"
  # Stillborn Indicator
