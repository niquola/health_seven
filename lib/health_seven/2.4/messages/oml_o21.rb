...
class OmlO21 < ::HealthSeven::Message# indent: 0
...
class ORDER_GENERAL < ::HealthSeven::SegmentGroup# indent: 0
  class CONTAINER_1 < ::HealthSeven::SegmentGroup# indent: 2
  attribute :sac, Sac, minOccurs: "1", maxOccurs: "1"
  attribute :obxes, Array[Obx], minOccurs: "0", maxOccurs: "unbounded"
  end
attribute :container_1, CONTAINER_1, minOccurs: "0", maxOccurs: "1"
  class ORDER < ::HealthSeven::SegmentGroup# indent: 2
  attribute :orc, Orc, minOccurs: "1", maxOccurs: "1"
      class OBSERVATION_REQUEST < ::HealthSeven::SegmentGroup# indent: 4
      attribute :obr, Obr, minOccurs: "1", maxOccurs: "1"
            class CONTAINER_2 < ::HealthSeven::SegmentGroup# indent: 6
            attribute :sac, Sac, minOccurs: "1", maxOccurs: "1"
            attribute :obxes, Array[Obx], minOccurs: "0", maxOccurs: "unbounded"
            end
      attribute :container_2s, Array[CONTAINER_2], minOccurs: "0", maxOccurs: "unbounded"
      ...
      attribute :observations, Array[OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
            class PRIOR_RESULT < ::HealthSeven::SegmentGroup# indent: 6
                    class PATIENT_PRIOR < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :pid, Pid, minOccurs: "1", maxOccurs: "1"
                    attribute :pd1, Pd1, minOccurs: "0", maxOccurs: "1"
                    end
            attribute :patient_prior, PATIENT_PRIOR, minOccurs: "0", maxOccurs: "1"
                    class PATIENT_VISIT_PRIOR < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :pv1, Pv1, minOccurs: "1", maxOccurs: "1"
                    attribute :pv2, Pv2, minOccurs: "0", maxOccurs: "1"
                    end
            attribute :patient_visit_prior, PATIENT_VISIT_PRIOR, minOccurs: "0", maxOccurs: "1"
            attribute :al1s, Array[Al1], minOccurs: "0", maxOccurs: "unbounded"
                    class ORDER_PRIOR < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :orc, Orc, minOccurs: "0", maxOccurs: "1"
                    attribute :obr, Obr, minOccurs: "1", maxOccurs: "1"
                    attribute :ntes, Array[Nte], minOccurs: "0", maxOccurs: "unbounded"
                              class OBSERVATION_PRIOR < ::HealthSeven::SegmentGroup# indent: 10
                              attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
                              attribute :ntes, Array[Nte], minOccurs: "0", maxOccurs: "unbounded"
                              end
...
attribute :order_generals, Array[ORDER_GENERAL], minOccurs: "1", maxOccurs: "unbounded"
end
end