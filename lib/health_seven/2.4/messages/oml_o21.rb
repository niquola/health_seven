...
class OmlO21 < ::HealthSeven::Message
  ...
  class ORDER_GENERAL < ::HealthSeven::SegmentGroup
    class CONTAINER_1 < ::HealthSeven::SegmentGroup
      attribute :sac, Sac, position: "SAC", require: true
      attribute :obxes, Array[Obx], position: "OBX", multiple: true
    end
    attribute :container_1, CONTAINER_1, position: "OML_O21.CONTAINER_1"
    class ORDER < ::HealthSeven::SegmentGroup
      attribute :orc, Orc, position: "ORC", require: true
      class OBSERVATION_REQUEST < ::HealthSeven::SegmentGroup
        attribute :obr, Obr, position: "OBR", require: true
        class CONTAINER_2 < ::HealthSeven::SegmentGroup
          attribute :sac, Sac, position: "SAC", require: true
          attribute :obxes, Array[Obx], position: "OBX", multiple: true
        end
        attribute :container_2s, Array[CONTAINER_2], position: "OML_O21.CONTAINER_2", multiple: true
  ...
  attribute :order_generals, Array[ORDER_GENERAL], position: "OML_O21.ORDER_GENERAL", require: true, multiple: true
end
end