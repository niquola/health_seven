...
class Rpt < ::HealthSeven::DataType
  # Repeat Pattern Code
  attribute :repeat_pattern_code, Cwe, position: "RPT.1", require: true
  # Calendar Alignment
  ...
  # Period Units
  attribute :period_units, Cwe, position: "RPT.6"
  ...
  # Event Offset Units
  attribute :event_offset_units, Cwe, position: "RPT.10"
