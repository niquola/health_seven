...
class OulR24 < ::HealthSeven::Message
  ...
  class PATIENT < ::HealthSeven::SegmentGroup
    ...
    attribute :patient_observations, Array[PATIENT_OBSERVATION], position: "OUL_R24.PATIENT_OBSERVATION", multiple: true
  ...
  class ORDER < ::HealthSeven::SegmentGroup
    ...
    class SPECIMEN < ::HealthSeven::SegmentGroup
      ...
      attribute :specimen_observations, Array[SPECIMEN_OBSERVATION], position: "OUL_R24.SPECIMEN_OBSERVATION", multiple: true
