...
class CcrI16 < ::HealthSeven::Message# indent: 0
attribute :msh, Msh, minOccurs: "1", maxOccurs: "1"
attribute :sfts, Array[Sft], minOccurs: "0", maxOccurs: "unbounded"
attribute :uac, Uac, minOccurs: "0", maxOccurs: "1"
attribute :rf1s, Array[Rf1], minOccurs: "1", maxOccurs: "unbounded"
...
class CLINICAL_ORDER < ::HealthSeven::SegmentGroup# indent: 0
attribute :orc, Orc, minOccurs: "1", maxOccurs: "1"
  class CLINICAL_ORDER_TIMING < ::HealthSeven::SegmentGroup# indent: 2
  attribute :tq1, Tq1, minOccurs: "1", maxOccurs: "1"
  attribute :tq2s, Array[Tq2], minOccurs: "0", maxOccurs: "unbounded"
  end
attribute :clinical_order_timings, Array[CLINICAL_ORDER_TIMING], minOccurs: "0", maxOccurs: "unbounded"
  class CLINICAL_ORDER_DETAIL < ::HealthSeven::SegmentGroup# indent: 2
      class CLINICAL_ORDER_OBJECT < ::HealthSeven::SegmentGroup# indent: 4
      
      end
  attribute :clinical_order_object, CLINICAL_ORDER_OBJECT, minOccurs: "1", maxOccurs: "1"
  attribute :obxes, Array[Obx], minOccurs: "0", maxOccurs: "unbounded"
  end
attribute :clinical_order_details, Array[CLINICAL_ORDER_DETAIL], minOccurs: "1", maxOccurs: "unbounded"
attribute :ctis, Array[Cti], minOccurs: "0", maxOccurs: "unbounded"
end
attribute :clinical_orders, Array[CLINICAL_ORDER], minOccurs: "0", maxOccurs: "unbounded"
