...
class OsmR26 < ::HealthSeven::Message# indent: 0
attribute :msh, Msh, minOccurs: "1", maxOccurs: "1"
attribute :sfts, Array[Sft], minOccurs: "0", maxOccurs: "unbounded"
attribute :uac, Uac, minOccurs: "0", maxOccurs: "1"
class SHIPMENT < ::HealthSeven::SegmentGroup# indent: 0
attribute :shp, Shp, minOccurs: "1", maxOccurs: "1"
attribute :prts, Array[Prt], minOccurs: "1", maxOccurs: "unbounded"
  class SHIPPING_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 2
...
attribute :shipping_observations, Array[SHIPPING_OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
  class PACKAGE < ::HealthSeven::SegmentGroup# indent: 2
  ...
  attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
      ...
      attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            class SPECIMEN_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 6
            attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            end
      attribute :specimen_observations, Array[SPECIMEN_OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
            ...
            attribute :sac, Sac, minOccurs: "1", maxOccurs: "1"
                    class CONTAINER_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
                    attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                    end
      ...
      attribute :containers, Array[CONTAINER], minOccurs: "0", maxOccurs: "unbounded"
            class SUBJECT_PERSON_ANIMAL_IDENTIFICATION < ::HealthSeven::SegmentGroup# indent: 6
            attribute :pid, Pid, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                    class PATIENT_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
                    attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                    end
      ...
      attribute :subject_person_animal_identification, SUBJECT_PERSON_ANIMAL_IDENTIFICATION, minOccurs: "0", maxOccurs: "1"
            class SUBJECT_POPULATION_LOCATION_IDENTIFICATION < ::HealthSeven::SegmentGroup# indent: 6
            attribute :pv1, Pv1, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                    class PATIENT_VISIT_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
                    attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                    end
