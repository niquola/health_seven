...
class BarP05 < ::HealthSeven::Message
  ...
  class Visit < ::HealthSeven::SegmentGroup
    ...
    attribute :procedures, Array[Procedure], position: "BAR_P05.PROCEDURE", multiple: true
    ...
    attribute :insurances, Array[Insurance], position: "BAR_P05.INSURANCE", multiple: true
    attribute :acc, Acc, position: "ACC"
    attribute :ub1, Ub1, position: "UB1"
    attribute :ub2, Ub2, position: "UB2"
    attribute :abs, Abs, position: "ABS"
    attribute :blcs, Array[Blc], position: "BLC", multiple: true
    attribute :rmi, Rmi, position: "RMI"
  end
  attribute :visits, Array[Visit], position: "BAR_P05.VISIT", require: true, multiple: true
end
end