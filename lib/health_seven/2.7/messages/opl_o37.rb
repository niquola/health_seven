  ...
  class ORDER < ::HealthSeven::SegmentGroup
    ...
    class PRIOR_RESULT < ::HealthSeven::SegmentGroup
      ...
      class ORDER_PRIOR < ::HealthSeven::SegmentGroup
        ...
        attribute :prts, Array[Prt], position: "PRT", multiple: true
        class TIMING2 < ::HealthSeven::SegmentGroup
          attribute :tq1, Tq1, position: "TQ1", require: true
          attribute :tq2s, Array[Tq2], position: "TQ2", multiple: true
        end
        attribute :timing2, TIMING2, position: "OPL_O37.TIMING2"
        class OBSERVATION_RESULT_GROUP < ::HealthSeven::SegmentGroup
          attribute :obx, Obx, position: "OBX", require: true
          attribute :prts, Array[Prt], position: "PRT", multiple: true
        end
        attribute :observation_result_groups, Array[OBSERVATION_RESULT_GROUP], position: "OPL_O37.OBSERVATION_RESULT_GROUP", require: true, multiple: true
      end
