...
attribute :nk1s, Array[Nk1], minOccurs: "1", maxOccurs: "unbounded"
  ...
  attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
      class OBSERVATIONS_ON_PATIENT < ::HealthSeven::SegmentGroup# indent: 4
...
attribute :patient, PATIENT, minOccurs: "0", maxOccurs: "1"
  ...
  attribute :specimen_observations, Array[SPECIMEN_OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
      ...
      attribute :sac, Sac, minOccurs: "1", maxOccurs: "1"
            class CONTAINER_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 6
            attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            end
  ...
  attribute :containers, Array[CONTAINER], minOccurs: "0", maxOccurs: "unbounded"
      ...
      attribute :dg1s, Array[Dg1], minOccurs: "0", maxOccurs: "unbounded"
            class ORDER_RELATED_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 6
            attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            end
...
attribute :specimen, Array[SPECIMEN], minOccurs: "1", maxOccurs: "unbounded"
  ...
  attribute :al1, Al1, minOccurs: "0", maxOccurs: "1"
      ...
      attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            class TIMING2 < ::HealthSeven::SegmentGroup# indent: 6
            attribute :tq1, Tq1, minOccurs: "1", maxOccurs: "1"
            attribute :tq2s, Array[Tq2], minOccurs: "0", maxOccurs: "unbounded"
            end
      attribute :timing2, TIMING2, minOccurs: "0", maxOccurs: "1"
            class OBSERVATION_RESULT_GROUP < ::HealthSeven::SegmentGroup# indent: 6
            attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            end
      attribute :observation_result_groups, Array[OBSERVATION_RESULT_GROUP], minOccurs: "1", maxOccurs: "unbounded"
      end
