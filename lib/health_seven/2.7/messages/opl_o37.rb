  ...
  class Order < ::HealthSeven::SegmentGroup
    ...
    class PriorResult < ::HealthSeven::SegmentGroup
      ...
      class OrderPrior < ::HealthSeven::SegmentGroup
        ...
        class ObservationResultGroup < ::HealthSeven::SegmentGroup
          attribute :obx, Obx, position: "OBX", require: true
          attribute :prts, Array[Prt], position: "PRT", multiple: true
        end
        attribute :observation_result_groups, Array[ObservationResultGroup], position: "OPL_O37.OBSERVATION_RESULT_GROUP", require: true, multiple: true
      end
