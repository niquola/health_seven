...
class OmgO19 < ::HealthSeven::Message
  ...
  class ORDER < ::HealthSeven::SegmentGroup
    ...
    class SPECIMEN < ::HealthSeven::SegmentGroup
      ...
      attribute :specimen_observations, Array[SPECIMEN_OBSERVATION], position: "OMG_O19.SPECIMEN_OBSERVATION", multiple: true
      class CONTAINER < ::HealthSeven::SegmentGroup
        ...
        attribute :container_observations, Array[CONTAINER_OBSERVATION], position: "OMG_O19.CONTAINER_OBSERVATION", multiple: true
      end
