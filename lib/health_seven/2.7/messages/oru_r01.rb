...
class OruR01 < ::HealthSeven::Message
  ...
  class PatientResult < ::HealthSeven::SegmentGroup
    class Patient < ::HealthSeven::SegmentGroup
      ...
      attribute :patient_observations, Array[PatientObservation], position: "ORU_R01.PATIENT_OBSERVATION", multiple: true
    ...
    class OrderObservation < ::HealthSeven::SegmentGroup
      ...
      class Specimen < ::HealthSeven::SegmentGroup
        ...
        attribute :specimen_observations, Array[SpecimenObservation], position: "ORU_R01.SPECIMEN_OBSERVATION", multiple: true
      end
