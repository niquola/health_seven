...
autoload :ADT_A44, File.dirname(__FILE__) + '/messages/adt_a44.rb'
...
autoload :CCF_I22, File.dirname(__FILE__) + '/messages/ccf_i22.rb'
autoload :CCI_I22, File.dirname(__FILE__) + '/messages/cci_i22.rb'
autoload :CCM_I21, File.dirname(__FILE__) + '/messages/ccm_i21.rb'
autoload :CCQ_I19, File.dirname(__FILE__) + '/messages/ccq_i19.rb'
autoload :CCR_I16, File.dirname(__FILE__) + '/messages/ccr_i16.rb'
autoload :CCU_I20, File.dirname(__FILE__) + '/messages/ccu_i20.rb'
autoload :CQU_I19, File.dirname(__FILE__) + '/messages/cqu_i19.rb'
...
autoload :EHC_E01, File.dirname(__FILE__) + '/messages/ehc_e01.rb'
autoload :EHC_E02, File.dirname(__FILE__) + '/messages/ehc_e02.rb'
autoload :EHC_E04, File.dirname(__FILE__) + '/messages/ehc_e04.rb'
autoload :EHC_E10, File.dirname(__FILE__) + '/messages/ehc_e10.rb'
autoload :EHC_E12, File.dirname(__FILE__) + '/messages/ehc_e12.rb'
autoload :EHC_E13, File.dirname(__FILE__) + '/messages/ehc_e13.rb'
autoload :EHC_E15, File.dirname(__FILE__) + '/messages/ehc_e15.rb'
autoload :EHC_E20, File.dirname(__FILE__) + '/messages/ehc_e20.rb'
autoload :EHC_E21, File.dirname(__FILE__) + '/messages/ehc_e21.rb'
autoload :EHC_E24, File.dirname(__FILE__) + '/messages/ehc_e24.rb'
...
autoload :MFN_M16, File.dirname(__FILE__) + '/messages/mfn_m16.rb'
autoload :MFN_M17, File.dirname(__FILE__) + '/messages/mfn_m17.rb'
...
autoload :OML_O39, File.dirname(__FILE__) + '/messages/oml_o39.rb'
...
autoload :OPL_O37, File.dirname(__FILE__) + '/messages/opl_o37.rb'
autoload :OPR_O38, File.dirname(__FILE__) + '/messages/opr_o38.rb'
autoload :OPU_R25, File.dirname(__FILE__) + '/messages/opu_r25.rb'
autoload :ORA_R33, File.dirname(__FILE__) + '/messages/ora_r33.rb'
...
autoload :ORL_O40, File.dirname(__FILE__) + '/messages/orl_o40.rb'
...
autoload :OSM_R26, File.dirname(__FILE__) + '/messages/osm_r26.rb'
...
autoload :QBP_E03, File.dirname(__FILE__) + '/messages/qbp_e03.rb'
autoload :QBP_E22, File.dirname(__FILE__) + '/messages/qbp_e22.rb'
...
autoload :RSP_E03, File.dirname(__FILE__) + '/messages/rsp_e03.rb'
autoload :RSP_E22, File.dirname(__FILE__) + '/messages/rsp_e22.rb'
autoload :RSP_K11, File.dirname(__FILE__) + '/messages/rsp_k11.rb'
autoload :RSP_K21, File.dirname(__FILE__) + '/messages/rsp_k21.rb'
autoload :RSP_K22, File.dirname(__FILE__) + '/messages/rsp_k22.rb'
...
autoload :RSP_K32, File.dirname(__FILE__) + '/messages/rsp_k32.rb'
...
autoload :SDR_S31, File.dirname(__FILE__) + '/messages/sdr_s31.rb'
autoload :SDR_S32, File.dirname(__FILE__) + '/messages/sdr_s32.rb'
autoload :SIU_S12, File.dirname(__FILE__) + '/messages/siu_s12.rb'
autoload :SLR_S28, File.dirname(__FILE__) + '/messages/slr_s28.rb'
...
autoload :STC_S33, File.dirname(__FILE__) + '/messages/stc_s33.rb'
