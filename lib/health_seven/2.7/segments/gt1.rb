...
class GT1 < ::HealthSeven::Segment
  ...
  attribute :guarantor_date_time_of_birth, DTM, minOccurs: "0", maxOccurs: "1"
  # Guarantor Administrative Sex
  attribute :guarantor_administrative_sex, CWE, minOccurs: "0", maxOccurs: "1"
  # Guarantor Type
  attribute :guarantor_type, CWE, minOccurs: "0", maxOccurs: "1"
  # Guarantor Relationship
  attribute :guarantor_relationship, CWE, minOccurs: "0", maxOccurs: "1"
  # Guarantor SSN
  ...
  attribute :guarantor_employment_status, CWE, minOccurs: "0", maxOccurs: "1"
  ...
  attribute :guarantor_credit_rating_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Guarantor Death Date And Time
  attribute :guarantor_death_date_and_time, DTM, minOccurs: "0", maxOccurs: "1"
  # Guarantor Death Flag
  attribute :guarantor_death_flag, ID, minOccurs: "0", maxOccurs: "1"
  # Guarantor Charge Adjustment Code
  attribute :guarantor_charge_adjustment_code, CWE, minOccurs: "0", maxOccurs: "1"
  ...
  attribute :guarantor_marital_status_code, CWE, minOccurs: "0", maxOccurs: "1"
  ...
  # Contact Reason
  attribute :contact_reason, CWE, minOccurs: "0", maxOccurs: "1"
  # Contact Relationship
  attribute :contact_relationship, CWE, minOccurs: "0", maxOccurs: "1"
  # Job Title
  ...
  # Guarantor Race
  attribute :guarantor_races, Array[CWE], minOccurs: "0", maxOccurs: "unbounded"
