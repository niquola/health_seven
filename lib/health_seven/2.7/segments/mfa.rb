...
class Mfa < ::HealthSeven::Segment
  ...
  attribute :event_completion_date_time, Dtm, position: "MFA.3"
  # MFN Record Level Error Return
  attribute :mfn_record_level_error_return, Cwe, position: "MFA.4", require: true
  # Primary Key Value - MFA
  attribute :primary_key_value_mfas, Array[AnyType], position: "MFA.5", require: true, multiple: true
