...
class In1 < ::HealthSeven::Segment
  ...
  # Health Plan ID
  attribute :health_plan_id, Cwe, position: "IN1.2", require: true
  ...
  # Plan Type
  attribute :plan_type, Cwe, position: "IN1.15"
  # Name Of Insured
  ...
  attribute :assignment_of_benefits, Cwe, position: "IN1.20"
  # Coordination Of Benefits
  attribute :coordination_of_benefits, Cwe, position: "IN1.21"
  ...
  attribute :release_information_code, Cwe, position: "IN1.27"
  # Pre-Admit Cert (PAC)
  ...
  attribute :type_of_agreement_code, Cwe, position: "IN1.31"
  # Billing Status
  attribute :billing_status, Cwe, position: "IN1.32"
  ...
  # Company Plan Code
  attribute :company_plan_code, Cwe, position: "IN1.35"
  # Policy Number
  ...
  attribute :insured_s_administrative_sex, Cwe, position: "IN1.43"
  ...
  attribute :prior_insurance_plan_id, Cwe, position: "IN1.46"
  # Coverage Type
  attribute :coverage_type, Cwe, position: "IN1.47"
  # Handicap
  attribute :handicap, Cwe, position: "IN1.48"
  # Insured's ID Number
  attribute :insured_s_id_numbers, Array[Cx], position: "IN1.49", multiple: true
  # Signature Code
  attribute :signature_code, Cwe, position: "IN1.50"
  # Signature Code Date
  attribute :signature_code_date, Dt, position: "IN1.51"
  # Insured's Birth Place
  attribute :insured_s_birth_place, St, position: "IN1.52"
  # VIP Indicator
  attribute :vip_indicator, Cwe, position: "IN1.53"
  # External Health Plan Identifiers
  attribute :external_health_plan_identifiers, Array[Cx], position: "IN1.54", multiple: true
end
end