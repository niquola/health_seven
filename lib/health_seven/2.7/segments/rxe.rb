...
class Rxe < ::HealthSeven::Segment
  # Give Code
  attribute :give_code, Cwe, position: "RXE.2", require: true
  # Give Amount - Minimum
  attribute :give_amount_minimum, Nm, position: "RXE.3", require: true
  # Give Amount - Maximum
  attribute :give_amount_maximum, Nm, position: "RXE.4"
  # Give Units
  attribute :give_units, Cwe, position: "RXE.5", require: true
  # Give Dosage Form
  attribute :give_dosage_form, Cwe, position: "RXE.6"
  # Provider's Administration Instructions
  attribute :provider_s_administration_instructions, Array[Cwe], position: "RXE.7", multiple: true
  # Substitution Status
  attribute :substitution_status, Id, position: "RXE.9"
  # Dispense Amount
  attribute :dispense_amount, Nm, position: "RXE.10"
  # Dispense Units
  attribute :dispense_units, Cwe, position: "RXE.11"
  # Number Of Refills
  ...
  attribute :d_t_of_most_recent_refill_or_dose_dispensed, Dtm, position: "RXE.18"
  # Total Daily Dose
  ...
  attribute :pharmacy_treatment_supplier_s_special_dispensing_instructions, Array[Cwe], position: "RXE.21", multiple: true
  # Give Per (Time Unit)
  attribute :give_per_time_unit, St, position: "RXE.22"
  # Give Rate Amount
  attribute :give_rate_amount, St, position: "RXE.23"
  # Give Rate Units
  attribute :give_rate_units, Cwe, position: "RXE.24"
  # Give Strength
  attribute :give_strength, Nm, position: "RXE.25"
  # Give Strength Units
  attribute :give_strength_units, Cwe, position: "RXE.26"
  # Give Indication
  attribute :give_indications, Array[Cwe], position: "RXE.27", multiple: true
  # Dispense Package Size
  attribute :dispense_package_size, Nm, position: "RXE.28"
  # Dispense Package Size Unit
  attribute :dispense_package_size_unit, Cwe, position: "RXE.29"
  # Dispense Package Method
  attribute :dispense_package_method, Id, position: "RXE.30"
  # Supplementary Code
  attribute :supplementary_codes, Array[Cwe], position: "RXE.31", multiple: true
  # Original Order Date/Time
  attribute :original_order_date_time, Dtm, position: "RXE.32"
  ...
  attribute :pharmacy_phone_numbers, Array[Xtn], position: "RXE.45", multiple: true
end
end