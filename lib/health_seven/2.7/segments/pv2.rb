...
class Pv2 < ::HealthSeven::Segment
  ...
  # Accommodation Code
  attribute :accommodation_code, Cwe, position: "PV2.2"
  # Admit Reason
  attribute :admit_reason, Cwe, position: "PV2.3"
  # Transfer Reason
  attribute :transfer_reason, Cwe, position: "PV2.4"
  # Patient Valuables
  ...
  # Visit User Code
  attribute :visit_user_codes, Array[Cwe], position: "PV2.7", multiple: true
  # Expected Admit Date/Time
  attribute :expected_admit_date_time, Dtm, position: "PV2.8"
  # Expected Discharge Date/Time
  attribute :expected_discharge_date_time, Dtm, position: "PV2.9"
  ...
  # Purge Status Code
  attribute :purge_status_code, Cwe, position: "PV2.16"
  # Purge Status Date
  attribute :purge_status_date, Dt, position: "PV2.17"
  # Special Program Code
  attribute :special_program_code, Cwe, position: "PV2.18"
  # Retention Indicator
  ...
  attribute :visit_publicity_code, Cwe, position: "PV2.21"
  ...
  # Patient Status Code
  attribute :patient_status_code, Cwe, position: "PV2.24"
  # Visit Priority Code
  attribute :visit_priority_code, Cwe, position: "PV2.25"
  # Previous Treatment Date
  attribute :previous_treatment_date, Dt, position: "PV2.26"
  # Expected Discharge Disposition
  attribute :expected_discharge_disposition, Cwe, position: "PV2.27"
  ...
  attribute :patient_charge_adjustment_code, Cwe, position: "PV2.30"
  # Recurring Service Code
  attribute :recurring_service_code, Cwe, position: "PV2.31"
  # Billing Media Code
  attribute :billing_media_code, Id, position: "PV2.32"
  # Expected Surgery Date and Time
  attribute :expected_surgery_date_and_time, Dtm, position: "PV2.33"
  ...
  attribute :mode_of_arrival_code, Cwe, position: "PV2.38"
  # Recreational Drug Use Code
  attribute :recreational_drug_use_codes, Array[Cwe], position: "PV2.39", multiple: true
  # Admission Level of Care Code
  attribute :admission_level_of_care_code, Cwe, position: "PV2.40"
  # Precaution Code
  attribute :precaution_codes, Array[Cwe], position: "PV2.41", multiple: true
  # Patient Condition Code
  attribute :patient_condition_code, Cwe, position: "PV2.42"
  # Living Will Code
  attribute :living_will_code, Cwe, position: "PV2.43"
  # Organ Donor Code
  attribute :organ_donor_code, Cwe, position: "PV2.44"
  # Advance Directive Code
  attribute :advance_directive_codes, Array[Cwe], position: "PV2.45", multiple: true
  # Patient Status Effective Date
  attribute :patient_status_effective_date, Dt, position: "PV2.46"
  # Expected LOA Return Date/Time
  attribute :expected_loa_return_date_time, Dtm, position: "PV2.47"
  # Expected Pre-admission Testing Date/Time
  attribute :expected_pre_admission_testing_date_time, Dtm, position: "PV2.48"
  # Notify Clergy Code
  attribute :notify_clergy_codes, Array[Cwe], position: "PV2.49", multiple: true
  # Advance Directive Last Verified Date
  attribute :advance_directive_last_verified_date, Dt, position: "PV2.50"
end
end