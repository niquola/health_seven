...
class Spm < ::HealthSeven::Segment
  ...
  attribute :specimen_received_date_time, Dtm, position: "SPM.18"
  # Specimen Expiration Date/Time
  attribute :specimen_expiration_date_time, Dtm, position: "SPM.19"
  ...
  # Accession ID
  attribute :accession_ids, Array[Cx], position: "SPM.30", multiple: true
  # Other Specimen ID
  attribute :other_specimen_ids, Array[Cx], position: "SPM.31", multiple: true
  # Shipment ID
  attribute :shipment_ids, Array[Ei], position: "SPM.32", multiple: true
end
end