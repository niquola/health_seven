...
attribute :producer_s_service_test_observation_id, Cwe, minOccurs: "1", maxOccurs: "1"
...
# Producer ID
attribute :producer_id, Cwe, minOccurs: "1", maxOccurs: "1"
# Observation Description
attribute :observation_description, Tx, minOccurs: "0", maxOccurs: "1"
# Other Service/Test/Observation IDs for the Observation
attribute :other_service_test_observation_ids_for_the_observation, Cwe, minOccurs: "0", maxOccurs: "1"
# Other Names
...
attribute :preferred_short_name_or_mnemonic_for_the_observation, St, minOccurs: "0", maxOccurs: "1"
...
attribute :identity_of_instrument_used_to_perform_this_studies, Array[Cwe], minOccurs: "0", maxOccurs: "unbounded"
# Coded Representation of Method
attribute :coded_representation_of_methods, Array[Cwe], minOccurs: "0", maxOccurs: "unbounded"
...
attribute :observation_producing_department_sections, Array[Cwe], minOccurs: "0", maxOccurs: "unbounded"
...
attribute :nature_of_service_test_observation, Cwe, minOccurs: "1", maxOccurs: "1"
# Report Subheader
attribute :report_subheader, Cwe, minOccurs: "0", maxOccurs: "1"
...
attribute :date_time_stamp_for_any_change_in_definition_for_the_observation, Dtm, minOccurs: "0", maxOccurs: "1"
...
attribute :outside_site_s_where_observation_may_be_performeds, Array[Cwe], minOccurs: "0", maxOccurs: "unbounded"
...
attribute :observations_required_to_interpret_this_observation, Cwe, minOccurs: "0", maxOccurs: "1"
# Interpretation of Observations
attribute :interpretation_of_observations, Tx, minOccurs: "0", maxOccurs: "1"
# Contraindications to Observations
attribute :contraindications_to_observations, Cwe, minOccurs: "0", maxOccurs: "1"
# Reflex Tests/Observations
attribute :reflex_tests_observations, Array[Cwe], minOccurs: "0", maxOccurs: "unbounded"
...
attribute :fixed_canned_message, Cwe, minOccurs: "0", maxOccurs: "1"
# Patient Preparation
attribute :patient_preparation, Tx, minOccurs: "0", maxOccurs: "1"
# Procedure Medication
attribute :procedure_medication, Cwe, minOccurs: "0", maxOccurs: "1"
...
attribute :kind_of_quantity_observed, Cwe, minOccurs: "0", maxOccurs: "1"
# Point Versus Interval
attribute :point_versus_interval, Cwe, minOccurs: "0", maxOccurs: "1"
# Challenge Information
attribute :challenge_information, Tx, minOccurs: "0", maxOccurs: "1"
# Relationship Modifier
attribute :relationship_modifier, Cwe, minOccurs: "0", maxOccurs: "1"
# Target Anatomic Site Of Test
attribute :target_anatomic_site_of_test, Cwe, minOccurs: "0", maxOccurs: "1"
# Modality of Imaging Measurement
attribute :modality_of_imaging_measurement, Cwe, minOccurs: "0", maxOccurs: "1"
end
end