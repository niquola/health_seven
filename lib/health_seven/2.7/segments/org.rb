...
class Org < ::HealthSeven::Segment
  ...
  attribute :organization_unit_code, Cwe, position: "ORG.2"
  # Organization Unit Type Code
  attribute :organization_unit_type_code, Cwe, position: "ORG.3"
  ...
  attribute :health_care_provider_type_code, Cwe, position: "ORG.6"
  # Health Care Provider Classification Code
  attribute :health_care_provider_classification_code, Cwe, position: "ORG.7"
  # Health Care Provider Area of Specialization Code
  attribute :health_care_provider_area_of_specialization_code, Cwe, position: "ORG.8"
  # Effective Date Range
  attribute :effective_date_range, Dr, position: "ORG.9"
  # Employment Status Code
  attribute :employment_status_code, Cwe, position: "ORG.10"
  ...
  # Cost Center Code
  attribute :cost_center_codes, Array[Cwe], position: "ORG.13", multiple: true
end
end