...
class Psl < ::HealthSeven::Segment
  ...
  attribute :product_service_clarification_code_types, Array[Cwe], position: "PSL.17", multiple: true
  ...
  attribute :processing_consideration_codes, Array[Cwe], position: "PSL.20", multiple: true
