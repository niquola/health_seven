...
class Psh < ::HealthSeven::Segment
  ...
  # Report Date
  attribute :report_date, Dtm, position: "PSH.3", require: true
  # Report Interval Start Date
  attribute :report_interval_start_date, Dtm, position: "PSH.4"
  # Report Interval End Date
  attribute :report_interval_end_date, Dtm, position: "PSH.5"
  ...
  attribute :number_of_product_experience_reports_filed_by_facility, Nm, position: "PSH.13"
  # Number of Product Experience Reports Filed by Distributor
  attribute :number_of_product_experience_reports_filed_by_distributor, Nm, position: "PSH.14"
end
end