...
autoload :Hxx, base_dir + '/segments/hxx'
autoload :Iam, base_dir + '/segments/iam'
autoload :Iar, base_dir + '/segments/iar'
...
autoload :Pac, base_dir + '/segments/pac'
...
autoload :Prt, base_dir + '/segments/prt'
...
autoload :Shp, base_dir + '/segments/shp'
...
autoload :Zl7, base_dir + '/segments/zl7'
autoload :Zxx, base_dir + '/segments/zxx'
end
