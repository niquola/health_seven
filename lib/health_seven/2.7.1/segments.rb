...
autoload :Hxx, File.dirname(__FILE__) + '/segments/hxx.rb'
autoload :IAM, File.dirname(__FILE__) + '/segments/iam.rb'
autoload :IAR, File.dirname(__FILE__) + '/segments/iar.rb'
...
autoload :PAC, File.dirname(__FILE__) + '/segments/pac.rb'
...
autoload :PRT, File.dirname(__FILE__) + '/segments/prt.rb'
...
autoload :SHP, File.dirname(__FILE__) + '/segments/shp.rb'
...
autoload :ZL7, File.dirname(__FILE__) + '/segments/zl7.rb'
autoload :Zxx, File.dirname(__FILE__) + '/segments/zxx.rb'
