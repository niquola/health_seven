...
class OulR23 < ::HealthSeven::Message
  ...
  class Patient < ::HealthSeven::SegmentGroup
    ...
    attribute :patient_observations, Array[PatientObservation], position: "OUL_R23.PATIENT_OBSERVATION", multiple: true
  ...
  class Specimen < ::HealthSeven::SegmentGroup
    ...
    attribute :specimen_observations, Array[SpecimenObservation], position: "OUL_R23.SPECIMEN_OBSERVATION", multiple: true
