...
class OmlO39 < ::HealthSeven::Message# indent: 0
...
attribute :timings, Array[TIMING], minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :observations, Array[OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
      class SPECIMEN_SHIPMENT < ::HealthSeven::SegmentGroup# indent: 4
      attribute :shp, Shp, minOccurs: "1", maxOccurs: "1"
            class SHIPMENT_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 6
            attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
            attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
            end
      attribute :shipment_observations, Array[SHIPMENT_OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
            class PACKAGE < ::HealthSeven::SegmentGroup# indent: 6
            attribute :pac, Pac, minOccurs: "1", maxOccurs: "1"
                    class SPECIMEN_IN_PACKAGE < ::HealthSeven::SegmentGroup# indent: 8
                    attribute :spm, Spm, minOccurs: "1", maxOccurs: "1"
                              class SPECIMEN_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 10
                              attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
                              attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                              end
                    attribute :specimen_observations, Array[SPECIMEN_OBSERVATION], minOccurs: "0", maxOccurs: "unbounded"
                              class SPECIMEN_CONTAINER_IN_PACKAGE < ::HealthSeven::SegmentGroup# indent: 10
                              attribute :sac, Sac, minOccurs: "1", maxOccurs: "1"
                                          class CONTAINER_OBSERVATION < ::HealthSeven::SegmentGroup# indent: 12
                                          attribute :obx, Obx, minOccurs: "1", maxOccurs: "1"
                                          attribute :prts, Array[Prt], minOccurs: "0", maxOccurs: "unbounded"
                                          end
