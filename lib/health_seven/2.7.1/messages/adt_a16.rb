...
class AdtA16 < ::HealthSeven::Message
  ...
  attribute :procedures, Array[PROCEDURE], position: "ADT_A16.PROCEDURE", multiple: true
  ...
  attribute :insurances, Array[INSURANCE], position: "ADT_A16.INSURANCE", multiple: true
