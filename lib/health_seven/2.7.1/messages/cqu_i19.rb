...
class CquI19 < ::HealthSeven::Message
  ...
  attribute :provider_contacts, Array[PROVIDER_CONTACT], position: "CQU_I19.PROVIDER_CONTACT", multiple: true
  ...
  class APPOINTMENT_HISTORY < ::HealthSeven::SegmentGroup
    ...
    class RESOURCES < ::HealthSeven::SegmentGroup
      ...
      class RESOURCE_DETAIL < ::HealthSeven::SegmentGroup
        ...
        attribute :resource_object, RESOURCE_OBJECT, position: "CQU_I19.RESOURCE_OBJECT", require: true
        attribute :obxes, Array[Obx], position: "OBX", multiple: true
      end
      attribute :resource_details, Array[RESOURCE_DETAIL], position: "CQU_I19.RESOURCE_DETAIL", multiple: true
    end
    attribute :resources, Array[RESOURCES], position: "CQU_I19.RESOURCES", multiple: true
  end
  attribute :appointment_histories, Array[APPOINTMENT_HISTORY], position: "CQU_I19.APPOINTMENT_HISTORY", multiple: true
  class CLINICAL_HISTORY < ::HealthSeven::SegmentGroup
    ...
    class CLINICAL_HISTORY_DETAIL < ::HealthSeven::SegmentGroup
      ...
      attribute :clinical_history_object, CLINICAL_HISTORY_OBJECT, position: "CQU_I19.CLINICAL_HISTORY_OBJECT", require: true
      attribute :obxes, Array[Obx], position: "OBX", multiple: true
    end
    attribute :clinical_history_details, Array[CLINICAL_HISTORY_DETAIL], position: "CQU_I19.CLINICAL_HISTORY_DETAIL", multiple: true
    class ROLE_CLINICAL_HISTORY < ::HealthSeven::SegmentGroup
      class ROLE_CLINICAL_HISTORY_OBJECT < ::HealthSeven::SegmentGroup
      
      end
      attribute :role_clinical_history_object, ROLE_CLINICAL_HISTORY_OBJECT, position: "CQU_I19.ROLE_CLINICAL_HISTORY_OBJECT", require: true
      attribute :vars, Array[Var], position: "VAR", multiple: true
    end
    attribute :role_clinical_histories, Array[ROLE_CLINICAL_HISTORY], position: "CQU_I19.ROLE_CLINICAL_HISTORY", multiple: true
    attribute :ctis, Array[Cti], position: "CTI", multiple: true
  end
  attribute :clinical_histories, Array[CLINICAL_HISTORY], position: "CQU_I19.CLINICAL_HISTORY", multiple: true
  class PATIENT_VISITS < ::HealthSeven::SegmentGroup
    attribute :pv1, Pv1, position: "PV1", require: true
    attribute :pv2, Pv2, position: "PV2"
  end
  attribute :patient_visits, Array[PATIENT_VISITS], position: "CQU_I19.PATIENT_VISITS", require: true, multiple: true
  class MEDICATION_HISTORY < ::HealthSeven::SegmentGroup
    ...
    attribute :medication_order_detail, MEDICATION_ORDER_DETAIL, position: "CQU_I19.MEDICATION_ORDER_DETAIL"
    ...
    attribute :medication_encoding_detail, MEDICATION_ENCODING_DETAIL, position: "CQU_I19.MEDICATION_ENCODING_DETAIL"
    ...
    attribute :medication_administration_details, Array[MEDICATION_ADMINISTRATION_DETAIL], position: "CQU_I19.MEDICATION_ADMINISTRATION_DETAIL", multiple: true
    attribute :ctis, Array[Cti], position: "CTI", multiple: true
  end
  attribute :medication_histories, Array[MEDICATION_HISTORY], position: "CQU_I19.MEDICATION_HISTORY", multiple: true
  class PROBLEM < ::HealthSeven::SegmentGroup
    ...
    class ROLE_PROBLEM < ::HealthSeven::SegmentGroup
      ...
      attribute :role_problem_object, ROLE_PROBLEM_OBJECT, position: "CQU_I19.ROLE_PROBLEM_OBJECT", require: true
      attribute :vars, Array[Var], position: "VAR", multiple: true
    end
    attribute :role_problems, Array[ROLE_PROBLEM], position: "CQU_I19.ROLE_PROBLEM", multiple: true
    attribute :obxes, Array[Obx], position: "OBX", multiple: true
  end
  ...
  class GOAL < ::HealthSeven::SegmentGroup
    ...
    class ROLE_GOAL < ::HealthSeven::SegmentGroup
      ...
      attribute :role_goal_object, ROLE_GOAL_OBJECT, position: "CQU_I19.ROLE_GOAL_OBJECT", require: true
      attribute :vars, Array[Var], position: "VAR", multiple: true
    end
    attribute :role_goals, Array[ROLE_GOAL], position: "CQU_I19.ROLE_GOAL", multiple: true
    attribute :obxes, Array[Obx], position: "OBX", multiple: true
  end
  ...
  class PATHWAY < ::HealthSeven::SegmentGroup
    ...
    class ROLE_PATHWAY < ::HealthSeven::SegmentGroup
      ...
      attribute :role_pathway_object, ROLE_PATHWAY_OBJECT, position: "CQU_I19.ROLE_PATHWAY_OBJECT", require: true
      attribute :vars, Array[Var], position: "VAR", multiple: true
    end
    attribute :role_pathways, Array[ROLE_PATHWAY], position: "CQU_I19.ROLE_PATHWAY", multiple: true
    attribute :obxes, Array[Obx], position: "OBX", multiple: true
  end
