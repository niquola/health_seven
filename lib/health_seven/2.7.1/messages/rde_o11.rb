...
class RdeO11 < ::HealthSeven::Message
  ...
  class PATIENT < ::HealthSeven::SegmentGroup
    ...
    attribute :patient_visit, PATIENT_VISIT, position: "RDE_O11.PATIENT_VISIT"
  ...
  class ORDER < ::HealthSeven::SegmentGroup
    ...
    attribute :order_detail, ORDER_DETAIL, position: "RDE_O11.ORDER_DETAIL"
    attribute :prts, Array[Prt], position: "PRT", multiple: true
    ...
    attribute :timing_encodeds, Array[TIMING_ENCODED], position: "RDE_O11.TIMING_ENCODED", require: true, multiple: true
    attribute :rxrs, Array[Rxr], position: "RXR", require: true, multiple: true
