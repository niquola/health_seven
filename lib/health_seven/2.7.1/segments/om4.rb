...
class Om4 < ::HealthSeven::Segment
  ...
  # Container Units
  attribute :container_units, Cwe, position: "OM4.5"
  # Specimen
  attribute :specimen, Cwe, position: "OM4.6"
  # Additive
  attribute :additive, Cwe, position: "OM4.7"
  # Preparation
  ...
  # Specimen Priorities
  attribute :specimen_priorities, Array[Id], position: "OM4.13", multiple: true
