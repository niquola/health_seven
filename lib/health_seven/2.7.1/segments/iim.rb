...
class Iim < ::HealthSeven::Segment
  ...
  attribute :inventory_expiration_date, Dtm, position: "IIM.4"
  ...
  attribute :inventory_received_date, Dtm, position: "IIM.7"
  ...
  attribute :inventory_on_hand_date, Dtm, position: "IIM.11"
  ...
  # Procedure Code
  attribute :procedure_code, Cne, position: "IIM.14"
  # Procedure Code Modifier
  attribute :procedure_code_modifiers, Array[Cne], position: "IIM.15", multiple: true
end
end