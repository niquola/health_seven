...
class In2 < ::HealthSeven::Segment
  ...
  attribute :employer_information_data, Cwe, position: "IN2.4"
  # Mail Claim Party
  attribute :mail_claim_parties, Array[Cwe], position: "IN2.5", multiple: true
  ...
  attribute :dependent_of_military_recipient, Cwe, position: "IN2.11"
  # Military Organization
  attribute :military_organization, St, position: "IN2.12"
  # Military Station
  attribute :military_station, St, position: "IN2.13"
  # Military Service
  attribute :military_service, Cwe, position: "IN2.14"
  # Military Rank/Grade
  attribute :military_rank_grade, Cwe, position: "IN2.15"
  # Military Status
  attribute :military_status, Cwe, position: "IN2.16"
  ...
  attribute :non_covered_insurance_codes, Array[Cwe], position: "IN2.24", multiple: true
  # Payor ID
  ...
  # Eligibility Source
  attribute :eligibility_source, Cwe, position: "IN2.27"
  ...
  # Living Dependency
  attribute :living_dependency, Cwe, position: "IN2.31"
  # Ambulatory Status
  attribute :ambulatory_statuses, Array[Cwe], position: "IN2.32", multiple: true
  # Citizenship
  attribute :citizenships, Array[Cwe], position: "IN2.33", multiple: true
  # Primary Language
  attribute :primary_language, Cwe, position: "IN2.34"
  # Living Arrangement
  attribute :living_arrangement, Cwe, position: "IN2.35"
  # Publicity Code
  attribute :publicity_code, Cwe, position: "IN2.36"
  # Protection Indicator
  attribute :protection_indicator, Id, position: "IN2.37"
  # Student Indicator
  attribute :student_indicator, Cwe, position: "IN2.38"
  # Religion
  attribute :religion, Cwe, position: "IN2.39"
  # Mother's Maiden Name
  attribute :mother_s_maiden_names, Array[Xpn], position: "IN2.40", multiple: true
  # Nationality
  attribute :nationality, Cwe, position: "IN2.41"
  # Ethnic Group
  attribute :ethnic_groups, Array[Cwe], position: "IN2.42", multiple: true
  # Marital Status
  attribute :marital_statuses, Array[Cwe], position: "IN2.43", multiple: true
  ...
  # Job Status
  attribute :job_status, Cwe, position: "IN2.48"
  ...
  attribute :employer_contact_reason, Cwe, position: "IN2.51"
  ...
  attribute :insured_s_contact_person_reasons, Array[Cwe], position: "IN2.54", multiple: true
  ...
  attribute :insurance_co_contact_reason, Cwe, position: "IN2.57"
  # Insurance Co Contact Phone Number
  attribute :insurance_co_contact_phone_numbers, Array[Xtn], position: "IN2.58", multiple: true
  # Policy Scope
  attribute :policy_scope, Cwe, position: "IN2.59"
  # Policy Source
  attribute :policy_source, Cwe, position: "IN2.60"
  # Patient Member Number
  attribute :patient_member_number, Cx, position: "IN2.61"
  # Guarantor's Relationship to Insured
  attribute :guarantor_s_relationship_to_insured, Cwe, position: "IN2.62"
  ...
  attribute :military_handicapped_program, Cwe, position: "IN2.65"
  # Suspend Flag
  ...
  # Race
  attribute :races, Array[Cwe], position: "IN2.71", multiple: true
  # Patient's Relationship to Insured
  attribute :patient_s_relationship_to_insured, Cwe, position: "IN2.72"
end
end