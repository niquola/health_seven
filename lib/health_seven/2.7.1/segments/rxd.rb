...
# Dispense/Give Code
attribute :dispense_give_code, Cwe, minOccurs: "1", maxOccurs: "1"
# Date/Time Dispensed
attribute :date_time_dispensed, Dtm, minOccurs: "1", maxOccurs: "1"
# Actual Dispense Amount
attribute :actual_dispense_amount, Nm, minOccurs: "1", maxOccurs: "1"
# Actual Dispense Units
attribute :actual_dispense_units, Cwe, minOccurs: "0", maxOccurs: "1"
# Actual Dosage Form
attribute :actual_dosage_form, Cwe, minOccurs: "0", maxOccurs: "1"
# Prescription Number
...
attribute :actual_strength_unit, Cwe, minOccurs: "0", maxOccurs: "1"
...
# Initiating Location
attribute :initiating_location, Cwe, minOccurs: "0", maxOccurs: "1"
# Packaging/Assembly Location
attribute :packaging_assembly_location, Cwe, minOccurs: "0", maxOccurs: "1"
