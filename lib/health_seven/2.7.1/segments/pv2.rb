...
class PV2 < ::HealthSeven::Segment
  ...
  # Accommodation Code
  attribute :accommodation_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Admit Reason
  attribute :admit_reason, CWE, minOccurs: "0", maxOccurs: "1"
  # Transfer Reason
  attribute :transfer_reason, CWE, minOccurs: "0", maxOccurs: "1"
  # Patient Valuables
  ...
  # Visit User Code
  attribute :visit_user_codes, Array[CWE], minOccurs: "0", maxOccurs: "unbounded"
  # Expected Admit Date/Time
  attribute :expected_admit_date_time, DTM, minOccurs: "0", maxOccurs: "1"
  # Expected Discharge Date/Time
  attribute :expected_discharge_date_time, DTM, minOccurs: "0", maxOccurs: "1"
  ...
  # Purge Status Code
  attribute :purge_status_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Purge Status Date
  attribute :purge_status_date, DT, minOccurs: "0", maxOccurs: "1"
  # Special Program Code
  attribute :special_program_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Retention Indicator
  ...
  attribute :visit_publicity_code, CWE, minOccurs: "0", maxOccurs: "1"
  ...
  # Patient Status Code
  attribute :patient_status_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Visit Priority Code
  attribute :visit_priority_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Previous Treatment Date
  attribute :previous_treatment_date, DT, minOccurs: "0", maxOccurs: "1"
  # Expected Discharge Disposition
  attribute :expected_discharge_disposition, CWE, minOccurs: "0", maxOccurs: "1"
  ...
  attribute :patient_charge_adjustment_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Recurring Service Code
  attribute :recurring_service_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Billing Media Code
  attribute :billing_media_code, ID, minOccurs: "0", maxOccurs: "1"
  # Expected Surgery Date and Time
  attribute :expected_surgery_date_and_time, DTM, minOccurs: "0", maxOccurs: "1"
  ...
  attribute :mode_of_arrival_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Recreational Drug Use Code
  attribute :recreational_drug_use_codes, Array[CWE], minOccurs: "0", maxOccurs: "unbounded"
  # Admission Level of Care Code
  attribute :admission_level_of_care_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Precaution Code
  attribute :precaution_codes, Array[CWE], minOccurs: "0", maxOccurs: "unbounded"
  # Patient Condition Code
  attribute :patient_condition_code, CWE, minOccurs: "0", maxOccurs: "1"
  # Living Will Code
  ...
  attribute :expected_loa_return_date_time, DTM, minOccurs: "0", maxOccurs: "1"
  # Expected Pre-admission Testing Date/Time
  attribute :expected_pre_admission_testing_date_time, DTM, minOccurs: "0", maxOccurs: "1"
  # Notify Clergy Code
  attribute :notify_clergy_codes, Array[CWE], minOccurs: "0", maxOccurs: "unbounded"
