...
class Prc < ::HealthSeven::Segment
  ...
  attribute :valid_patient_classes, Array[Cwe], position: "PRC.4", multiple: true
  # Price
  ...
  # Price Override Flag
  attribute :price_override_flag, Cwe, position: "PRC.13"
  # Billing Category
  ...
  # Charge on Indicator
  attribute :charge_on_indicator, Cwe, position: "PRC.18"
end
end