...
class Arq < ::HealthSeven::Segment
  ...
  # Schedule ID
  attribute :schedule_id, Cwe, position: "ARQ.5"
  # Request Event Reason
  attribute :request_event_reason, Cwe, position: "ARQ.6"
  # Appointment Reason
  attribute :appointment_reason, Cwe, position: "ARQ.7"
  # Appointment Type
  attribute :appointment_type, Cwe, position: "ARQ.8"
  # Appointment Duration
  attribute :appointment_duration, Nm, position: "ARQ.9"
  # Appointment Duration Units
  attribute :appointment_duration_units, Cne, position: "ARQ.10"
