...
autoload :ARD_A19, File.dirname(__FILE__) + '/messages/ard_a19.rb'
...
autoload :EDR_Q01, File.dirname(__FILE__) + '/messages/edr_q01.rb'
autoload :EQQ_Q01, File.dirname(__FILE__) + '/messages/eqq_q01.rb'
autoload :ERP_Q01, File.dirname(__FILE__) + '/messages/erp_q01.rb'
...
autoload :MFK_M02, File.dirname(__FILE__) + '/messages/mfk_m02.rb'
...
autoload :RQQ_Q01, File.dirname(__FILE__) + '/messages/rqq_q01.rb'
...
autoload :SPQ_Q01, File.dirname(__FILE__) + '/messages/spq_q01.rb'
...
autoload :TBR_Q01, File.dirname(__FILE__) + '/messages/tbr_q01.rb'
autoload :UDM_Q05, File.dirname(__FILE__) + '/messages/udm_q05.rb'
autoload :VQQ_Q01, File.dirname(__FILE__) + '/messages/vqq_q01.rb'
