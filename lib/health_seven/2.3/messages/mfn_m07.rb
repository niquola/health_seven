...
class MfnM07 < ::HealthSeven::Message
  ...
  class MfClinStudy < ::HealthSeven::SegmentGroup
    ...
    attribute :mf_phase_sched_details, Array[MfPhaseSchedDetail], position: "MFN_M07.MF_PHASE_SCHED_DETAIL", multiple: true
  end
  attribute :mf_clin_studies, Array[MfClinStudy], position: "MFN_M07.MF_CLIN_STUDY", require: true, multiple: true
end
end