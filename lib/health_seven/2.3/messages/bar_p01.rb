...
class BarP01 < ::HealthSeven::Message
  ...
  class VISIT < ::HealthSeven::SegmentGroup
    ...
    attribute :procedures, Array[PROCEDURE], position: "BAR_P01.PROCEDURE", multiple: true
    ...
    attribute :insurances, Array[INSURANCE], position: "BAR_P01.INSURANCE", multiple: true
    attribute :acc, Acc, position: "ACC"
    attribute :ub1, Ub1, position: "UB1"
    attribute :ub2, Ub2, position: "UB2"
  end
  attribute :visits, Array[VISIT], position: "BAR_P01.VISIT", require: true, multiple: true
end
end