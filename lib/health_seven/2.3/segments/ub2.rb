...
class Ub2 < ::HealthSeven::Segment
  ...
  attribute :condition_code_24_30s, Array[Id], position: "UB2.3", multiple: true
  # Covered Days (7)
  attribute :covered_days_7, St, position: "UB2.4"
  # Non-Covered Days (8)
  attribute :non_covered_days_8, St, position: "UB2.5"
  # Value Amount & Code
  attribute :value_amount_codes, Array[CmUvc], position: "UB2.6", multiple: true
  # Occurrence Code & Date (32-35)
  attribute :occurrence_code_date_32_35s, Array[CmOcd], position: "UB2.7", multiple: true
  # Occurrence Span Code/Dates (36)
  attribute :occurrence_span_code_dates_36s, Array[CmOsp], position: "UB2.8", multiple: true
