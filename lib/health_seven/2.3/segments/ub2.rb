...
class Ub2 < ::HealthSeven::Segment
  ...
  attribute :condition_code_24_30s, Array[Id], minOccurs: "0", maxOccurs: "unbounded"
  # Covered Days (7)
  attribute :covered_days_7, St, minOccurs: "0", maxOccurs: "1"
  # Non-Covered Days (8)
  attribute :non_covered_days_8, St, minOccurs: "0", maxOccurs: "1"
  # Value Amount & Code
  attribute :value_amount_codes, Array[CmUvc], minOccurs: "0", maxOccurs: "unbounded"
  # Occurrence Code & Date (32-35)
  attribute :occurrence_code_date_32_35s, Array[CmOcd], minOccurs: "0", maxOccurs: "unbounded"
  # Occurrence Span Code/Dates (36)
  attribute :occurrence_span_code_dates_36s, Array[CmOsp], minOccurs: "0", maxOccurs: "unbounded"
