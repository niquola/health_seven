...
class Pv1 < ::HealthSeven::Segment
  ...
  attribute :set_id_patient_visit, Si, position: "PV1.1"
  # Patient Class
  attribute :patient_class, Id, position: "PV1.2", require: true
  # Assigned Patient Location
  attribute :assigned_patient_location, Pl, position: "PV1.3"
  # Admission Type
  attribute :admission_type, Id, position: "PV1.4"
  # Preadmit Number
  attribute :preadmit_number, Cx, position: "PV1.5"
  # Prior Patient Location
  attribute :prior_patient_location, Pl, position: "PV1.6"
  # Attending Doctor
  attribute :attending_doctor, Xcn, position: "PV1.7"
  # Referring Doctor
  attribute :referring_doctor, Xcn, position: "PV1.8"
  # Consulting Doctor
  attribute :consulting_doctors, Array[Xcn], position: "PV1.9", multiple: true
  # Hospital Service
  attribute :hospital_service, Id, position: "PV1.10"
  # Temporary Location
  attribute :temporary_location, Pl, position: "PV1.11"
  # Preadmit Test Indicator
  attribute :preadmit_test_indicator, Id, position: "PV1.12"
  # Readmission Indicator
  attribute :readmission_indicator, Id, position: "PV1.13"
  # Admit Source
  attribute :admit_source, Id, position: "PV1.14"
  # Ambulatory Status
  attribute :ambulatory_status, Is, position: "PV1.15"
  # VIP Indicator
  attribute :vip_indicator, Id, position: "PV1.16"
  # Admitting Doctor
  attribute :admitting_doctor, Xcn, position: "PV1.17"
  # Patient Type
  attribute :patient_type, Id, position: "PV1.18"
  # Visit Number
  attribute :visit_number, Cx, position: "PV1.19"
  # Financial Class
  attribute :financial_classes, Array[Fc], position: "PV1.20", multiple: true
  # Charge Price Indicator
  attribute :charge_price_indicator, Id, position: "PV1.21"
  # Courtesy Code
  attribute :courtesy_code, Id, position: "PV1.22"
  # Credit Rating
  attribute :credit_rating, Id, position: "PV1.23"
  # Contract Code
  attribute :contract_codes, Array[Id], position: "PV1.24", multiple: true
  ...
  # Interest Code
  attribute :interest_code, Id, position: "PV1.28"
  # Transfer to Bad Debt Code
  attribute :transfer_to_bad_debt_code, Id, position: "PV1.29"
  # Transfer to Bad Debt Date
  attribute :transfer_to_bad_debt_date, Dt, position: "PV1.30"
  # Bad Debt Agency Code
  attribute :bad_debt_agency_code, Id, position: "PV1.31"
  # Bad Debt Transfer Amount
  attribute :bad_debt_transfer_amount, Nm, position: "PV1.32"
  # Bad Debt Recovery Amount
  attribute :bad_debt_recovery_amount, Nm, position: "PV1.33"
  # Delete Account Indicator
  attribute :delete_account_indicator, Id, position: "PV1.34"
  # Delete Account Date
  attribute :delete_account_date, Dt, position: "PV1.35"
  # Discharge Disposition
  attribute :discharge_disposition, Id, position: "PV1.36"
  # Discharged to Location
  attribute :discharged_to_location, CmDld, position: "PV1.37"
  # Diet Type
  attribute :diet_type, Id, position: "PV1.38"
  # Servicing Facility
  attribute :servicing_facility, Id, position: "PV1.39"
  # Bed Status
  attribute :bed_status, Is, position: "PV1.40"
  # Account Status
  attribute :account_status, Id, position: "PV1.41"
  # Pending Location
  ...
  # Discharge Date/Time
  attribute :discharge_date_time, Ts, position: "PV1.45"
