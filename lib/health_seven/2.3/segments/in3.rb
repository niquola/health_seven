...
class In3 < ::HealthSeven::Segment
  ...
  attribute :set_id_insurance_certification, Si, position: "IN3.1", require: true
  ...
  # Penalty
  attribute :penalty, CmPen, position: "IN3.5"
  # Certification Date/Time
  attribute :certification_date_time, Ts, position: "IN3.6"
  # Certification Modify Date/Time
  attribute :certification_modify_date_time, Ts, position: "IN3.7"
  # Operator
  ...
  # Days
  attribute :days, CmDtn, position: "IN3.11"
  # Non-Concur Code/Description
  attribute :non_concur_code_description, Ce, position: "IN3.12"
  # Non-Concur Effective Date/Time
  attribute :non_concur_effective_date_time, Ts, position: "IN3.13"
  # Physician Reviewer
  ...
  # Appeal Reason
  attribute :appeal_reason, Ce, position: "IN3.17"
  # Certification Agency
  attribute :certification_agency, Ce, position: "IN3.18"
  ...
  attribute :pre_certification_required_windows, Array[CmPcf], position: "IN3.20", multiple: true
  # Case Manager
