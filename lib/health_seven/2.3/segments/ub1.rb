...
class UB1 < ::HealthSeven::Segment
  ...
  attribute :value_amount_code_46_49s, Array[CMUvc], minOccurs: "0", maxOccurs: "unbounded"
  # Number Of Grace Days (90)
  attribute :number_of_grace_days_90, NM, minOccurs: "0", maxOccurs: "1"
  # Spec Program Indicator (44)
  attribute :spec_program_indicator_44, CE, minOccurs: "0", maxOccurs: "1"
  # PSRO/UR Approval Indicator (87)
  attribute :psro_ur_approval_indicator_87, ID, minOccurs: "0", maxOccurs: "1"
  ...
  # Occurrence (28 32)
  attribute :occurrence_28_32s, Array[CMOcd], minOccurs: "0", maxOccurs: "unbounded"
  # Occurrence Span (33)
