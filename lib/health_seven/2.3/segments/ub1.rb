...
class Ub1 < ::HealthSeven::Segment
  ...
  attribute :value_amount_code_46_49s, Array[CmUvc], position: "UB1.10", multiple: true
  # Number Of Grace Days (90)
  attribute :number_of_grace_days_90, Nm, position: "UB1.11"
  # Spec Program Indicator (44)
  attribute :spec_program_indicator_44, Ce, position: "UB1.12"
  # PSRO/UR Approval Indicator (87)
  attribute :psro_ur_approval_indicator_87, Id, position: "UB1.13"
  ...
  # Occurrence (28 32)
  attribute :occurrence_28_32s, Array[CmOcd], position: "UB1.16", multiple: true
  # Occurrence Span (33)
  attribute :occurrence_span_33, Id, position: "UB1.17"
