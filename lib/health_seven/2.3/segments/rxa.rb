...
class Rxa < ::HealthSeven::Segment# indent: 0
# Give Sub-ID Counter
attribute :give_sub_id_counter, Id, minOccurs: "1", maxOccurs: "1"
...
attribute :administering_provider, Xcn, minOccurs: "0", maxOccurs: "1"
# Administered-at Location
attribute :administered_at_location, CmLa1, minOccurs: "0", maxOccurs: "1"
...
attribute :substance_refusal_reasons, Array[Ce], minOccurs: "0", maxOccurs: "unbounded"
# Indication
