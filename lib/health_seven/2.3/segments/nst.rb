...
class Nst < ::HealthSeven::Segment
  ...
  attribute :statistics_available, Id, position: "NST.1"
  # Source Identifier
  attribute :source_identifier, St, position: "NST.2"
  # Source Type
  attribute :source_type, Id, position: "NST.3"
  # Statistics Start
  attribute :statistics_start, Ts, position: "NST.4"
  # Statistics End
  attribute :statistics_end, Ts, position: "NST.5"
  ...
  # Network Errors
  attribute :network_errors, Nm, position: "NST.15"
end
end