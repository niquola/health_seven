...
class Txa < ::HealthSeven::Segment
  ...
  attribute :primary_activity_provider_code_name, Xcn, position: "TXA.5"
  ...
  attribute :originator_code_name, Xcn, position: "TXA.9"
  ...
  attribute :transcriptionist_code_name, Xcn, position: "TXA.11"
  ...
  attribute :document_completion_statuses, Array[Id], position: "TXA.17", require: true, multiple: true
