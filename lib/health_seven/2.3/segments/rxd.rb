...
class Rxd < ::HealthSeven::Segment
  ...
  # Dispense Notes
  attribute :dispense_notes, Array[Ce], position: "RXD.9", multiple: true
  # Dispensing Provider
  attribute :dispensing_provider, Xcn, position: "RXD.10"
  # Substitution Status
  attribute :substitution_status, Id, position: "RXD.11"
  # Total Daily Dose
  attribute :total_daily_dose, Cq, position: "RXD.12"
  # Dispense-To Location
  attribute :dispense_to_location, CmLa1, position: "RXD.13"
  # Needs Human Review
  ...
  # Indication
  attribute :indication, Ce, position: "RXD.21"
