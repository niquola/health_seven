    ...
    class STUDY_PHASE < ::HealthSeven::SegmentGroup
      ...
      class STUDY_SCHEDULE < ::HealthSeven::SegmentGroup
        ...
        class ORCRXARXR_SUPPGRP < ::HealthSeven::SegmentGroup
          ...
          attribute :rxarxr_suppgrps, Array[RXARXR_SUPPGRP], position: "CSU_C09.RXARXR_SUPPGRP", require: true, multiple: true
        end
        attribute :orcrxarxr_suppgrps, Array[ORCRXARXR_SUPPGRP], position: "CSU_C09.ORCRXARXR_SUPPGRP", require: true, multiple: true
      end
