...
attribute :ntes, Array[Nte], minOccurs: "0", maxOccurs: "unbounded"
  class TQ1TQ2_SUPPGRP < ::HealthSeven::SegmentGroup# indent: 2
  attribute :tq1, Tq1, minOccurs: "1", maxOccurs: "1"
  attribute :tq2s, Array[Tq2], minOccurs: "0", maxOccurs: "unbounded"
  end
attribute :tq1_tq2_suppgrps, Array[TQ1TQ2_SUPPGRP], minOccurs: "0", maxOccurs: "unbounded"
  class SPMOBXSACINV_SUPPGRP < ::HealthSeven::SegmentGroup# indent: 2
...
attribute :spmobxsacinv_suppgrps, Array[SPMOBXSACINV_SUPPGRP], minOccurs: "0", maxOccurs: "unbounded"
  class OBXTCDSIDNTE_SUPPGRP < ::HealthSeven::SegmentGroup# indent: 2
