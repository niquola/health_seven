...
class MdmT02 < ::HealthSeven::Message
  ...
  attribute :common_orders, Array[CommonOrder], position: "MDM_T02.COMMON_ORDER", multiple: true
  attribute :txa, Txa, position: "TXA", require: true
  class ObxnteSuppgrp < ::HealthSeven::SegmentGroup
    attribute :obx, Obx, position: "OBX", require: true
    attribute :ntes, Array[Nte], position: "NTE", multiple: true
  end
  attribute :obxnte_suppgrps, Array[ObxnteSuppgrp], position: "MDM_T02.OBXNTE_SUPPGRP", require: true, multiple: true
end
end