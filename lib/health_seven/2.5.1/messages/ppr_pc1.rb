...
class PprPc1 < ::HealthSeven::Message
  ...
  class Problem < ::HealthSeven::SegmentGroup
    ...
    attribute :problem_observations, Array[ProblemObservation], position: "PPR_PC1.PROBLEM_OBSERVATION", multiple: true
    ...
    class Order < ::HealthSeven::SegmentGroup
      ...
      class OrderDetail < ::HealthSeven::SegmentGroup
        class ObrSuppgrp < ::HealthSeven::SegmentGroup
        
        end
        attribute :obr_suppgrp, ObrSuppgrp, position: "PPR_PC1.OBR_SUPPGRP", require: true
        attribute :ntes, Array[Nte], position: "NTE", multiple: true
        attribute :vars, Array[Var], position: "VAR", multiple: true
