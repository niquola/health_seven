...
class Bpo < ::HealthSeven::Segment
  ...
  attribute :bp_universal_service_id, Cwe, position: "BPO.2", require: true
  ...
  # BP Units
  attribute :bp_units, Ce, position: "BPO.6"
  # BP Intended Use Date/Time
  attribute :bp_intended_use_date_time, Ts, position: "BPO.7"
  ...
  attribute :bp_requested_dispense_date_time, Ts, position: "BPO.10"
