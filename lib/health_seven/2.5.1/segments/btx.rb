...
class Btx < ::HealthSeven::Segment
  ...
  # BP Units
  attribute :bp_units, Ce, position: "BTX.10"
  ...
  attribute :bp_date_time_of_status, Ts, position: "BTX.13", require: true
  # BP Administrator
  attribute :bp_administrator, Xcn, position: "BTX.14"
  # BP Verifier
  attribute :bp_verifier, Xcn, position: "BTX.15"
  # BP Transfusion Start Date/Time of Status
  attribute :bp_transfusion_start_date_time_of_status, Ts, position: "BTX.16"
  # BP Transfusion End Date/Time of Status
  attribute :bp_transfusion_end_date_time_of_status, Ts, position: "BTX.17"
