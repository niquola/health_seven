...
class OM3 < ::HealthSeven::Segment
  ...
  attribute :abnormal_text_codes_for_categorical_observations, Array[CE], minOccurs: "0", maxOccurs: "unbounded"
  # Critical Text/Codes for Categorical Observations
  attribute :critical_text_codes_for_categorical_observations, Array[CE], minOccurs: "0", maxOccurs: "unbounded"
  # Value Type
