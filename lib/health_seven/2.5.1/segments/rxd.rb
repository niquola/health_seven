...
class Rxd < ::HealthSeven::Segment
  ...
  # Supplementary Code
  attribute :supplementary_codes, Array[Ce], position: "RXD.25", multiple: true
  # Initiating Location
  attribute :initiating_location, Ce, position: "RXD.26"
  # Packaging/Assembly Location
  attribute :packaging_assembly_location, Ce, position: "RXD.27"
