...
class OBX < Segment
  ...
  # Observation Value
  attribute :observation_value, Varies, minOccurs: "0", maxOccurs: "unbounded"
  # Units
  attribute :units, CE, minOccurs: "0", maxOccurs: "1"
  # References Range
  attribute :references_range, ST, minOccurs: "0", maxOccurs: "1"
  # Abnormal Flags
  attribute :abnormal_flags, IS, minOccurs: "0", maxOccurs: "unbounded"
  # Probability
  attribute :probability, NM, minOccurs: "0", maxOccurs: "1"
  # Nature of Abnormal Test
  attribute :nature_of_abnormal_test, ID, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :responsible_observer, XCN, minOccurs: "0", maxOccurs: "unbounded"
  # Observation Method
  attribute :observation_method, CE, minOccurs: "0", maxOccurs: "unbounded"
  # Equipment Instance Identifier
  attribute :equipment_instance_identifier, EI, minOccurs: "0", maxOccurs: "unbounded"
