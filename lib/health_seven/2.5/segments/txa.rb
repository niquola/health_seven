...
class TXA < Segment
  ...
  attribute :primary_activity_provider_code_name, XCN, minOccurs: "0", maxOccurs: "unbounded"
  ...
  # Edit Date/Time
  attribute :edit_date_time, TS, minOccurs: "0", maxOccurs: "unbounded"
  # Originator Code/Name
  attribute :originator_code_name, XCN, minOccurs: "0", maxOccurs: "unbounded"
  # Assigned Document Authenticator
  attribute :assigned_document_authenticator, XCN, minOccurs: "0", maxOccurs: "unbounded"
  # Transcriptionist Code/Name
  attribute :transcriptionist_code_name, XCN, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :authentication_person_time_stamp, PPN, minOccurs: "0", maxOccurs: "unbounded"
  # Distributed Copies (Code and Name of Recipients)
  attribute :distributed_copies_code_and_name_of_recipients, XCN, minOccurs: "0", maxOccurs: "unbounded"
end
end