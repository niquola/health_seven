...
class Con < ::HealthSeven::Segment
  ...
  # Consent Form ID
  attribute :consent_form_id, St, position: "CON.3"
  # Consent Form Number
  ...
  # Consent Background
  attribute :consent_backgrounds, Array[Ft], position: "CON.7", multiple: true
  # Subject-specific Consent Background
  attribute :subject_specific_consent_backgrounds, Array[Ft], position: "CON.8", multiple: true
  ...
  attribute :consent_discussion_date_time, Ts, position: "CON.12"
  # Consent Decision Date/Time
  attribute :consent_decision_date_time, Ts, position: "CON.13"
  # Consent Effective Date/Time
  attribute :consent_effective_date_time, Ts, position: "CON.14"
  # Consent End Date/Time
  attribute :consent_end_date_time, Ts, position: "CON.15"
  ...
  attribute :language_translated_to, Id, position: "CON.18"
  ...
  attribute :relationship_to_subject_tables, Array[Is], position: "CON.25", require: true, multiple: true
end
end