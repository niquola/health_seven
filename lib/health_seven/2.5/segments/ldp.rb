...
class LDP < Segment
  ...
  # Location Service
  attribute :location_service, IS, minOccurs: "0", maxOccurs: "unbounded"
  # Specialty Type
  attribute :specialty_type, CE, minOccurs: "0", maxOccurs: "unbounded"
  ...
  # Visiting Hours
  attribute :visiting_hours, VH, minOccurs: "0", maxOccurs: "unbounded"
  # Contact Phone
