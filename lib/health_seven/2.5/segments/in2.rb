...
class IN2 < Segment
  ...
  attribute :special_coverage_approval_name, XPN, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :non_covered_insurance_code, IS, minOccurs: "0", maxOccurs: "unbounded"
  # Payor ID
  attribute :payor_id, CX, minOccurs: "0", maxOccurs: "unbounded"
  # Payor Subscriber ID
  attribute :payor_subscriber_id, CX, minOccurs: "0", maxOccurs: "unbounded"
  # Eligibility Source
  attribute :eligibility_source, IS, minOccurs: "0", maxOccurs: "1"
  # Room Coverage Type/Amount
  attribute :room_coverage_type_amount, RMC, minOccurs: "0", maxOccurs: "unbounded"
  # Policy Type/Amount
  attribute :policy_type_amount, PTA, minOccurs: "0", maxOccurs: "unbounded"
  # Daily Deductible
  ...
  # Marital Status
  attribute :marital_status, CE, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :employer_contact_person_name, XPN, minOccurs: "0", maxOccurs: "unbounded"
  # Employer Contact Person Phone Number
  attribute :employer_contact_person_phone_number, XTN, minOccurs: "0", maxOccurs: "unbounded"
  # Employer Contact Reason
  attribute :employer_contact_reason, IS, minOccurs: "0", maxOccurs: "1"
  # Insured's Contact Person's Name
  attribute :insured_s_contact_person_s_name, XPN, minOccurs: "0", maxOccurs: "unbounded"
  # Insured's Contact Person Phone Number
  attribute :insured_s_contact_person_phone_number, XTN, minOccurs: "0", maxOccurs: "unbounded"
  # Insured's Contact Person Reason
  attribute :insured_s_contact_person_reason, IS, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :relationship_to_the_patient_stop_date, DT, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :insured_s_phone_number_home, XTN, minOccurs: "0", maxOccurs: "unbounded"
  # Insured's Employer Phone Number
  attribute :insured_s_employer_phone_number, XTN, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :insured_organization_name_and_id, XON, minOccurs: "0", maxOccurs: "unbounded"
  # Insured Employer Organization Name and ID
  attribute :insured_employer_organization_name_and_id, XON, minOccurs: "0", maxOccurs: "unbounded"
  # Race
