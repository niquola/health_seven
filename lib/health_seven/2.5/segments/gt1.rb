...
class Gt1 < ::HealthSeven::Segment
  ...
  attribute :guarantor_administrative_sex, Is, position: "GT1.9"
  # Guarantor Type
  attribute :guarantor_type, Is, position: "GT1.10"
  # Guarantor Relationship
  attribute :guarantor_relationship, Ce, position: "GT1.11"
  # Guarantor SSN
  ...
  attribute :guarantor_marital_status_code, Ce, position: "GT1.30"
  ...
  # Ambulatory Status
  attribute :ambulatory_statuses, Array[Is], position: "GT1.34", multiple: true
  # Citizenship
  attribute :citizenships, Array[Ce], position: "GT1.35", multiple: true
  # Primary Language
  attribute :primary_language, Ce, position: "GT1.36"
  # Living Arrangement
  attribute :living_arrangement, Is, position: "GT1.37"
  # Publicity Code
  attribute :publicity_code, Ce, position: "GT1.38"
  # Protection Indicator
  attribute :protection_indicator, Id, position: "GT1.39"
  # Student Indicator
  attribute :student_indicator, Is, position: "GT1.40"
  # Religion
  attribute :religion, Ce, position: "GT1.41"
  # Mother's Maiden Name
  attribute :mother_s_maiden_names, Array[Xpn], position: "GT1.42", multiple: true
  # Nationality
  attribute :nationality, Ce, position: "GT1.43"
  # Ethnic Group
  attribute :ethnic_groups, Array[Ce], position: "GT1.44", multiple: true
  ...
  attribute :contact_relationship, Is, position: "GT1.48"
  # Job Title
  ...
  # Guarantor Race
  attribute :guarantor_races, Array[Ce], position: "GT1.55", multiple: true
  # Guarantor Birth Place
  attribute :guarantor_birth_place, St, position: "GT1.56"
  # VIP Indicator
  attribute :vip_indicator, Is, position: "GT1.57"
end
end