...
class QRF < Segment
  ...
  attribute :where_subject_filter, ST, minOccurs: "1", maxOccurs: "unbounded"
  ...
  # What User Qualifier
  attribute :what_user_qualifier, ST, minOccurs: "0", maxOccurs: "unbounded"
  # Other QRY Subject Filter
  attribute :other_qry_subject_filter, ST, minOccurs: "0", maxOccurs: "unbounded"
  # Which Date/Time Qualifier
  attribute :which_date_time_qualifier, ID, minOccurs: "0", maxOccurs: "unbounded"
  # Which Date/Time Status Qualifier
  attribute :which_date_time_status_qualifier, ID, minOccurs: "0", maxOccurs: "unbounded"
  # Date/Time Selection Qualifier
  attribute :date_time_selection_qualifier, ID, minOccurs: "0", maxOccurs: "unbounded"
