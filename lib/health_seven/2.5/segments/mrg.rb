...
class MRG < Segment
  ...
  attribute :prior_patient_identifier_list, CX, minOccurs: "1", maxOccurs: "unbounded"
  # Prior Alternate Patient ID
  attribute :prior_alternate_patient_id, CX, minOccurs: "0", maxOccurs: "unbounded"
  ...
  # Prior Patient Name
  attribute :prior_patient_name, XPN, minOccurs: "0", maxOccurs: "unbounded"
end
end