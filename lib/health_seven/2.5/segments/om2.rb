...
class OM2 < Segment
  ...
  attribute :range_of_decimal_precision, NM, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :reference_normal_range_ordinal_and_continuous_observations, RFR, minOccurs: "0", maxOccurs: "unbounded"
  # Critical Range for Ordinal and Continuous Observations
  attribute :critical_range_for_ordinal_and_continuous_observations, RFR, minOccurs: "0", maxOccurs: "unbounded"
  ...
  attribute :delta_check_criteria, DLT, minOccurs: "0", maxOccurs: "unbounded"
