...
class RpaI08 < ::HealthSeven::Message
  ...
  class Authorization1 < ::HealthSeven::SegmentGroup
    attribute :aut, Aut, position: "AUT", require: true
    attribute :ctd, Ctd, position: "CTD"
  end
  attribute :authorization1, Authorization1, position: "RPA_I08.AUTHORIZATION_1"
  ...
  class Procedure < ::HealthSeven::SegmentGroup
    ...
    attribute :authorization2, Authorization2, position: "RPA_I08.AUTHORIZATION_2"
  end
