...
class INSURANCE
  ...
  attribute :abs, ABS.CONTENT, comment: nil, minOccurs: "0", maxOccurs: "1"
  attribute :blc, BLC.CONTENT, comment: nil, minOccurs: "0", maxOccurs: "unbounded"
  attribute :rmi, RMI.CONTENT, comment: nil, minOccurs: "0", maxOccurs: "1"
end
