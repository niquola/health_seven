...
class INSURANCE < SegmentGroup
  ...
  attribute :abs, ABS, comment: nil, minOccurs: "0", maxOccurs: "1"
  attribute :blcs, Array[BLC], comment: nil, minOccurs: "0", maxOccurs: "unbounded"
  attribute :rmi, RMI, comment: nil, minOccurs: "0", maxOccurs: "1"
end
