...
class BAR_P05 < ::HealthSeven::Message# indent: 0
...
attribute :abs, ABS, minOccurs: "0", maxOccurs: "1"
attribute :blcs, Array[BLC], minOccurs: "0", maxOccurs: "unbounded"
attribute :rmi, RMI, minOccurs: "0", maxOccurs: "1"
end
