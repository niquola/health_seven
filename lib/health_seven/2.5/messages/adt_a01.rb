...
class ADT_A01 < Message
  attribute :msh, MSH, minOccurs: nil, maxOccurs: nil
  attribute :sfts, Array[SFT], minOccurs: "0", maxOccurs: "unbounded"
  attribute :evn, EVN, minOccurs: nil, maxOccurs: nil
  attribute :pid, PID, minOccurs: nil, maxOccurs: nil
  attribute :pd1, PD1, minOccurs: "0", maxOccurs: nil
  attribute :rols, Array[ROL], minOccurs: "0", maxOccurs: "unbounded"
  attribute :nk1s, Array[NK1], minOccurs: "0", maxOccurs: "unbounded"
  attribute :pv1, PV1, minOccurs: nil, maxOccurs: nil
...
class PROCEDURE < SegmentGroup
  attribute :pr1, PR1, minOccurs: nil, maxOccurs: nil
  attribute :rols, Array[ROL], minOccurs: "0", maxOccurs: "unbounded"
end
...
class INSURANCE < SegmentGroup
  attribute :in1, IN1, minOccurs: nil, maxOccurs: nil
