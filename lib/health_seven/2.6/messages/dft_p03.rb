...
class DftP03 < ::HealthSeven::Message
  ...
  class FINANCIAL < ::HealthSeven::SegmentGroup
    ...
    class FINANCIAL_COMMON_ORDER < ::HealthSeven::SegmentGroup
      ...
      attribute :financial_timing_quantities, Array[FINANCIAL_TIMING_QUANTITY], position: "DFT_P03.FINANCIAL_TIMING QUANTITY", multiple: true
    ...
    attribute :financial_common_orders, Array[FINANCIAL_COMMON_ORDER], position: "DFT_P03.FINANCIAL_COMMON ORDER", multiple: true
  end
