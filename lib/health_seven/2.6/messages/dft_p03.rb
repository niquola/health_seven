...
class DftP03 < ::HealthSeven::Message
  ...
  class Financial < ::HealthSeven::SegmentGroup
    ...
    class FinancialCommonOrder < ::HealthSeven::SegmentGroup
      ...
      attribute :financial_timing_quantities, Array[FinancialTimingQuantity], position: "DFT_P03.FINANCIAL_TIMING QUANTITY", multiple: true
    ...
    attribute :financial_common_orders, Array[FinancialCommonOrder], position: "DFT_P03.FINANCIAL_COMMON ORDER", multiple: true
  end
