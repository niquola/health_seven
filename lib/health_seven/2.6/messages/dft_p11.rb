...
class DftP11 < ::HealthSeven::Message
  ...
  class FINANCIAL < ::HealthSeven::SegmentGroup
    ...
    class FINANCIAL_COMMON_ORDER < ::HealthSeven::SegmentGroup
      ...
      attribute :financial_timing_quantities, Array[FINANCIAL_TIMING_QUANTITY], position: "DFT_P11.FINANCIAL_TIMING QUANTITY", multiple: true
    ...
    attribute :financial_common_orders, Array[FINANCIAL_COMMON_ORDER], position: "DFT_P11.FINANCIAL_COMMON ORDER", multiple: true
    attribute :dg1s, Array[Dg1], position: "DG1", multiple: true
    attribute :drg, Drg, position: "DRG"
    attribute :gt1s, Array[Gt1], position: "GT1", multiple: true
