...
class SrmS01 < ::HealthSeven::Message
  ...
  class RESOURCES < ::HealthSeven::SegmentGroup
    ...
    attribute :general_resources, Array[GENERAL_RESOURCE], position: "SRM_S01.GENERAL RESOURCE", multiple: true
    class LOCATION_RESOURCE < ::HealthSeven::SegmentGroup
      attribute :ail, Ail, position: "AIL", require: true
      attribute :apr, Apr, position: "APR"
      attribute :ntes, Array[Nte], position: "NTE", multiple: true
    end
    attribute :location_resources, Array[LOCATION_RESOURCE], position: "SRM_S01.LOCATION RESOURCE", multiple: true
    class PERSONNEL_RESOURCE < ::HealthSeven::SegmentGroup
      attribute :aip, Aip, position: "AIP", require: true
      attribute :apr, Apr, position: "APR"
      attribute :ntes, Array[Nte], position: "NTE", multiple: true
    end
    attribute :personnel_resources, Array[PERSONNEL_RESOURCE], position: "SRM_S01.PERSONNEL RESOURCE", multiple: true
  end
