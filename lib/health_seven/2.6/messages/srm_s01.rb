...
class SrmS01 < ::HealthSeven::Message
  ...
  class Resources < ::HealthSeven::SegmentGroup
    ...
    attribute :general_resources, Array[GeneralResource], position: "SRM_S01.GENERAL RESOURCE", multiple: true
    class LocationResource < ::HealthSeven::SegmentGroup
      attribute :ail, Ail, position: "AIL", require: true
      attribute :apr, Apr, position: "APR"
      attribute :ntes, Array[Nte], position: "NTE", multiple: true
    end
    attribute :location_resources, Array[LocationResource], position: "SRM_S01.LOCATION RESOURCE", multiple: true
    class PersonnelResource < ::HealthSeven::SegmentGroup
      attribute :aip, Aip, position: "AIP", require: true
      attribute :apr, Apr, position: "APR"
      attribute :ntes, Array[Nte], position: "NTE", multiple: true
    end
    attribute :personnel_resources, Array[PersonnelResource], position: "SRM_S01.PERSONNEL RESOURCE", multiple: true
  end
