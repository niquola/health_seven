...
class Ivc < ::HealthSeven::Segment
  ...
  # Invoice Control
  attribute :invoice_control, Is, position: "IVC.4", require: true
  # Invoice Reason
  attribute :invoice_reason, Is, position: "IVC.5", require: true
  # Invoice Type
  attribute :invoice_type, Is, position: "IVC.6", require: true
  # Invoice Date/Time
  ...
  # Benefit Group
  attribute :benefit_group, Is, position: "IVC.25", require: true
  # Provider Tax ID
  attribute :provider_tax_id, St, position: "IVC.26"
  # Payer Tax ID
  attribute :payer_tax_id, St, position: "IVC.27"
  # Provider Tax status
  attribute :provider_tax_status, Is, position: "IVC.28"
  # Payer Tax status
  attribute :payer_tax_status, Is, position: "IVC.29"
  # Sales Tax ID
