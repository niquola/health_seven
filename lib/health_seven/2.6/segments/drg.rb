...
# Status Patient
attribute :status_patient, Is, minOccurs: "0", maxOccurs: "1"
...
attribute :status_financial_calculation, Is, minOccurs: "0", maxOccurs: "1"
...
# Status Gender
attribute :status_gender, Is, minOccurs: "0", maxOccurs: "1"
# Status Age
attribute :status_age, Is, minOccurs: "0", maxOccurs: "1"
# Status Length of Stay
attribute :status_length_of_stay, Is, minOccurs: "0", maxOccurs: "1"
# Status Same Day Flag
attribute :status_same_day_flag, Is, minOccurs: "0", maxOccurs: "1"
# Status Separation Mode
attribute :status_separation_mode, Is, minOccurs: "0", maxOccurs: "1"
# Status Weight at Birth
attribute :status_weight_at_birth, Is, minOccurs: "0", maxOccurs: "1"
# Status Respiration Minutes
attribute :status_respiration_minutes, Is, minOccurs: "0", maxOccurs: "1"
# Status Admission
attribute :status_admission, Is, minOccurs: "0", maxOccurs: "1"
end
end