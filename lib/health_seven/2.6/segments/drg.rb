...
class Drg < ::HealthSeven::Segment
  ...
  # Status Patient
  attribute :status_patient, Is, position: "DRG.17"
  ...
  attribute :status_financial_calculation, Is, position: "DRG.20"
  ...
  # Status Gender
  attribute :status_gender, Is, position: "DRG.26"
  # Status Age
  attribute :status_age, Is, position: "DRG.27"
  # Status Length of Stay
  attribute :status_length_of_stay, Is, position: "DRG.28"
  # Status Same Day Flag
  attribute :status_same_day_flag, Is, position: "DRG.29"
  # Status Separation Mode
  attribute :status_separation_mode, Is, position: "DRG.30"
  # Status Weight at Birth
  attribute :status_weight_at_birth, Is, position: "DRG.31"
  # Status Respiration Minutes
  attribute :status_respiration_minutes, Is, position: "DRG.32"
  # Status Admission
  attribute :status_admission, Is, position: "DRG.33"
end
end