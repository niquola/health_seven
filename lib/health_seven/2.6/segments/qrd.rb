...
class Qrd < ::HealthSeven::Segment
  # Query Date/Time
  attribute :query_date_time, Dtm, position: "QRD.1", require: true
  # Query Format Code
  ...
  attribute :deferred_response_date_time, Dtm, position: "QRD.6"
  ...
  # What Subject Filter
  attribute :what_subject_filters, Array[Cwe], position: "QRD.9", require: true, multiple: true
  # What Department Data Code
  attribute :what_department_data_codes, Array[Cwe], position: "QRD.10", require: true, multiple: true
