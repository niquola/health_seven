...
class Qrd < ::HealthSeven::Segment# indent: 0
# Query Date/Time
attribute :query_date_time, Dtm, minOccurs: "1", maxOccurs: "1"
# Query Format Code
...
attribute :deferred_response_date_time, Dtm, minOccurs: "0", maxOccurs: "1"
...
# What Subject Filter
attribute :what_subject_filters, Array[Cwe], minOccurs: "1", maxOccurs: "unbounded"
# What Department Data Code
attribute :what_department_data_codes, Array[Cwe], minOccurs: "1", maxOccurs: "unbounded"
